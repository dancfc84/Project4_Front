...
![Screenshot - Jira](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/jira.png) 
...
![Screenshot - Jira2](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/jira2.png) 
...
![Screenshot - wireframes](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/wireframes.png) 

Database relationship diagram

![Screenshot - dbreal](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/dbrealationships.png) 
...
![Screenshot - bookmodel](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/bookmodel.png) 

Here is the wish list join table, which joined a book.id with a user.id.

![Screenshot - jointable](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/jointable.png) 

I used SQL queries in my controller routes to gather the relevant data and send it back as JSON. 

![Screenshot - getbooks](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/getbookscontroller.png) 
...
![Screenshot - cartcontext](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/cartcontext.png) 

 
store/CartProvider.js

![Screenshot - cartprovider](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/cartprovider.png) 


I then wrapped all the components that require access to my Cart state in the CartProvider in my App.js file.

![Screenshot - wrappedcartprovider](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/wrappedcartprovider.png) 
...
![Screenshot - cartreducer](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/cartreducer.png) 

![Screenshot - usereducer](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/cartreducerdispatch.png) 
...
![Screenshot - dispatchfunction](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/dispatchfunction.png) 
...
![Screenshot - mixedcontent](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/mixedcontent.png) 
...
![Screenshot - head](https://github.com/dancfc84/Project4_Front/blob/master/screenshots/head.png) 
